    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Features"
                    heading="Built for modern brands and creators"
                    description="our AI instantly generates professional lifestyle imagery and short-form videos optimized for commercials & Reels."
                />
