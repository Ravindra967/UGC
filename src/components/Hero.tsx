...
export default function Hero() {
    ...
    const mainImageUrl = 'https://images.pexels.com/photos/3182762/pexels-photo-3182762.jpeg?q=80&w=1600&auto=format&fit=crop';
                                ...
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-400">
                                            Optimized social formats, no editing needed
                                        </div>
                                    </div>
                                </div>
