   ...
   return (
     <div className="min-h-screen text-white p-6 md:p-12 mt-28">
        ...
        <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
            ...
            <Title heading='Create In-Contect Image' description="Upload your model and product image to generate stunning UGC, short-from videos and social media posts"/>
            ...
            <div className="flex gap-20 max-sm:flex-col items-start justify-between">
                ...
                <div className="w-full">
                    ...
                    <div className="mb-4 text-gray-400">
                        ...
                        <textarea id="productDescription" value={productDescription} rows={4} onChange={(e) => setProductDescription(e.target.value)} placeholder="Describe the product features, usage, and benefits" className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all resize-none h-24"/>
                    </div>
                    ...
                    <div className="mb-4 text-gray-400">
                        ...
                        <textarea id="UserPrompt" value={userPrompt} rows={4} onChange={(e) => setUserPrompt(e.target.value)} placeholder="Describe what you want to generate for this product" className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all resize-none h-24"/>
                    </div>
                </div>
            </div>
